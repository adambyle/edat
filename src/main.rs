...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/search/entry/:id/:query", get(routes::components::search::entry))
        .route("/search/intro/:id/:query", get(routes::components::search::intro))
        .route("/search/section/:id/:query", get(routes::components::search::section))
        .route("/search/volume/:id/:query", get(routes::components::search::volume))
